...
class TestPipelineIntegration:
    ...
    def test_audit_batch_processes_multiple_examples(self, make_fake_provider) -> None:
        ...
        examples = [
            {"source": "This is a valid grounding document for the first test example.", "question": "What is the first example?", "answer": "This is the first answer."},
            {"source": "This is a valid grounding document for the second test example.", "question": "What is the second example?", "answer": "This is the second answer."},
        ]
    ...
    def test_empty_answer_produces_fail_with_no_claims(self, make_fake_provider) -> None:
        ...
        with pytest.raises(InputError):
            hunter.audit(
                source="This is a grounding document with enough text to pass the minimum length validation rule.",
